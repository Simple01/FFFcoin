...
uint256 hashGenesisBlock("0x00000000c7c3e04b0af94e02b54fe29562122b62a663a6d63fd95492aedf7b84");
...
const string strMessageMagic = "FFFcoin Signed Message:\n";
...
{
    int64 nSubsidy = 4444 * COIN;

    // Subsidy is cut in half every 4444 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 4444);

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 604800;
static const int64 nTargetSpacing = 240;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000000c7c3e04b0af94e02b54fe29562122b62a663a6d63fd95492aedf7b84");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1420846111;
        block.nBits    = 486604799;
        block.nNonce   = 2717396693;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("FFFcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("FFFcoinMiner : ProcessBlock, block not accepted");
    }
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running FFFcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("FFFcoinMiner terminated\n");
        throw;
    }
}
